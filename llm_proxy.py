...
class Config:
    def __init__(self):
        ...
        self.api_key = os.environ.get("API_KEY", "sk-faker")  # 本地模型通常不需要真实API key
...
class MessagesRequest(BaseModel):
    ...
    def validate_model_field(cls, v, info):
        ...
        logger.info(f"📋 MODEL VALIDATION: Original='{original_model}', Big='{config.big_model}', Small='{config.small_model}'")
